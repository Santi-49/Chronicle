...
services/
  ai/           Local Python AI service — FastAPI + LangChain, called by the Electron
                main over 127.0.0.1; part of the desktop product, NOT the control plane
  api/          FastAPI control plane — fully implemented, extend via module contract
  module/       Challenge-specific gateway logic — reuses services/ai
packages/
  contracts/
