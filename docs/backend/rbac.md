...
| `user` | Protected hello plus own account settings/encrypted-secret/export/erasure operations |
...
| `hello` | admin, user | — | — |
| `account` | admin, user | admin, user | admin, user (self-service own account only) |
